  ...
  switch (name) {
    ...
    case "surname":
      ...
      if (!regex.test(value.trim()))
        errorMsg = "Doit comporter entre 2 et 30 caractères alphabétiques";
      break;
    case "username":
      regex = new RegExp(/^(?=[a-zA-Z0-9._]{5,20}$)(?!.*[_.]{2})[^_.].*[^_.]$/);
      if (!regex.test(value.trim()))
        errorMsg = "Doit comporter entre 5 et 30 caractères alphanumériques";
      break;
    case "email":
      regex = new RegExp(
